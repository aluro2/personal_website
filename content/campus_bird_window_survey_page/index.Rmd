...
htmlwidgets::saveWidget(species_plot, file = "species_plot.html")

htmltools::includeHTML("species_plot.html")
...
bird_map_data %>% 
  ...
  htmlwidgets::saveWidget(., file = "bird_leaflet_map.html")

htmltools::includeHTML("bird_leaflet_map.html")
```
